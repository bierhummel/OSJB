...
<head>
    ...
    <title>OSJB - Datenschutzerklärung</title>
</head>
...
<body>
    ...
    <div id="content">
        ...
        <section>
            ...
            <p>OSJB e.V.<br>Ammerländer Heerstr. 114-118, <br>26129 Oldenburg Deutschland</p>
            <p><strong>Vertretungsberechtigte Personen:</strong> Vorstand: Alexandra Oswald und Eike Janßen</p>
            <p><strong>E-Mail-Adresse:</strong> <a href="mailto:datenschutz@osjb.de">datenschutz@osjb.de</a></p>
            <p><strong>Telefon:</strong> +49 441 798-0 </p>
            <p><strong>Impressum:</strong> Impressum</p>
            ...
            <p><strong>Bootstrap:</strong> Bootstrap ist ein freies Frontend-CSS-Framework. Es enthält auf HTML und CSS basierende Gestaltungsvorlagen für Typografie, Formulare, Buttons, Tabellen, Grid-Systeme, Navigations- und andere Oberflächengestaltungselemente sowie zusätzliche, optionale JavaScript-Erweiterungen.<br /> Um diese Bibliothek optimal zu nutzen, verwenden wir ein sogenanntes CDN (Content Delivery Network). Dadurch ergeben sich erhebliche Performance Vorteile, zudem werden Fehler innerhalb der Bibliothek umfassend gefixt, ohne dass wir zusätzlich eingreifen müssen. Auf Wunsch kann die Bibliothek auch lokal vom Server geladen werden.</p>
            
            <p><strong>Verwendung von Webfonts:</strong> Auf diesen Internetseiten werden externe Schriften, Google Fonts verwendet. Google Fonts ist ein Dienst der Google Inc. (&quot;Google&quot;). Die Einbindung dieser Web Fonts erfolgt durch einen Serveraufruf, in der Regel ein Server von Google in den USA. Hierdurch wird an den Server &uuml;bermittelt, welche unserer Internetseiten Sie besucht haben. Auch wird die IP-Adresse des Browsers des Endger&auml;tes des Besuchers dieser Internetseiten von Google gespeichert. N&auml;here Informationen finden Sie in den Datenschutzhinweisen von Google, die Sie hier abrufen k&ouml;nnen:<br> <a href="https://www.google.com/fonts#AboutPlace:about" class="text" rel="nofollow" target="_blank">www.google.com/fonts#AboutPlace:about</a><br> <a href="https://www.google.com/policies/privacy/" class="text" rel="nofollow" target="_blank">www.google.com/policies/privacy/</a></p>
